...
public class signup_RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.signup_activity_join);
        ...
        check_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (UserEmail.equals("")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(signup_RegisterActivity.this);
                ...
                signup_ValidateRequest signupValidateRequest = new signup_ValidateRequest(UserEmail, responseListener);
                RequestQueue queue = Volley.newRequestQueue(signup_RegisterActivity.this);
        ...
        join_button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                        ...
                        try {
                            ...
                            if(UserPwd.equals(PassCk)) {
                                if (success) {
                                    ...
                                    Intent intent = new Intent(signup_RegisterActivity.this, com.example.mindit.signup_LoginActivity.class);
                ...
                //서버로 Volley를 이용해서 요청
                signup_RegisterRequest registerRequest = new signup_RegisterRequest( UserEmail, UserPwd, UserName, responseListener);
                RequestQueue queue = Volley.newRequestQueue( signup_RegisterActivity.this );
