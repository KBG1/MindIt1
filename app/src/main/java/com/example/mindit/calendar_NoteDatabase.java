...
public class calendar_NoteDatabase {
    private static final String TAG = "NoteDatabase";

    private static calendar_NoteDatabase database;
    ...
    private calendar_NoteDatabase(Context context){
        this.context = context;
    }

    public static calendar_NoteDatabase getInstance(Context context){
        if(database == null){
            database = new calendar_NoteDatabase(context);
        }
