...
public class Todolist_NoteDatabase {
    private static final String TAG = "NoteDatabase";

    private static Todolist_NoteDatabase database;
    ...
    private Todolist_NoteDatabase(Context context){
        this.context = context;
    }

    public static Todolist_NoteDatabase getInstance(Context context){
        if(database == null){
            database = new Todolist_NoteDatabase(context);
        }
