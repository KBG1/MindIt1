...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    ...
    //todolist아이템이 들어갈 배열
    ArrayList<calendar_Note> items = new ArrayList<>();
    ...
    public NoteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.calendar_todo_item, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setItem(calendar_Note item){
    ...
    //배열에 있는 item들을 가리킴
    public void setItems(ArrayList<calendar_Note> items){
        this.items = items;
    }
