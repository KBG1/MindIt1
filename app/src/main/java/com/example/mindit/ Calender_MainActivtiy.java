...
import android.content.Intent;//화면간의 이동을 돕는 라이브러리
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;
import android.os.Bundle;
import android.view.View;//화면을 구성하는 view를 가져옴
import android.widget.Button;//activity_main에 있는 Button을 가져옴
import android.widget.CalendarView;//activity_main에 있는 CalendarView을 가져옴
import android.widget.EditText;//activity_main에 있는 EditText을 가져옴
import android.widget.TextView;//activity_main에 있는 TextView을 가져옴
